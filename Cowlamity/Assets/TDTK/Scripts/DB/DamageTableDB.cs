...
namespace TDTK {
	...
	public class DamageTableDB : MonoBehaviour {
		...
		public static DamageTableDB LoadDB(){
			GameObject obj=Resources.Load("DB_TDTK/DamageTableDB", typeof(GameObject)) as GameObject;
			...
			private static GameObject CreatePrefab(){
				...
				GameObject prefab=PrefabUtility.CreatePrefab("Assets/TDTK/Resources/DB_TDTK/DamageTableDB.prefab", obj, ReplacePrefabOptions.ConnectToPrefab);
