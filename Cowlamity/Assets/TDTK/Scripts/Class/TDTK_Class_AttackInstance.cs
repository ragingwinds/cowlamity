...
namespace TDTK {
	...
	public class AttackInstance {
		...
		public void Process_SrcWeapon(){
			...
			if(Random.Range(0f, 1f)<srcWeapon.GetShieldBreak() && tgtUnit.defaultShield>0) breakShield=true;
		...
		public void Process_SrcUnit(){
			...
			if(Random.Range(0f, 1f)<srcUnit.GetShieldBreak() && tgtUnit.defaultShield>0) breakShield=true;
